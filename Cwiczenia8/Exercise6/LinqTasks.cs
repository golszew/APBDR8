...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            var methodSyntax = Emps.Where(e => e.Job
                    .Equals("Frontend programmer") && e.Salary > 1000)
        ...
        {
            var methodSyntax = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (emp, dept) => new
            {
                emp.Ename,
                emp.Job,
                dept.Dname
        ...
        {
            var methodSyntax = Emps.GroupBy(e => e.Job).Select(group => new
            {
                Praca = group.Key,
        ...
        {
            var methodSyntax = Emps.OrderByDescending(e => e.HireDate)
        ...
        public static IEnumerable<object> Task11()
        {
            var methodSyntax = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (emp, dept) => new
            {
                ...
                emp.Job,
                dept.Dname
            }).GroupBy(d => d.Dname).Select(e => new
            {
                name = e.Key,
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.TaskMethod(Emps);
            return result;
        }
        ...
        {
            var methodSyntax = Depts.GroupJoin(Emps, d => d.Deptno, e => e.Deptno,
                    ((dept, emp) => new
                    {
                        Department = dept,
                        count = emp.Count()
    ...
    {
        public static IEnumerable<Emp> TaskMethod(IEnumerable<Emp> emps)
        {
